...
public class JsonUtil {
    ...
    static {
        ...
        xssSerializerObjectMapper.configure(Feature.ALLOW_COMMENTS, true);
        xssSerializerObjectMapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);

        // The servlet version of the XssSerializerObjectMapper sets inclusion level differently.
        servletXssSerializerObjectMapper.setSerializationInclusion(Include.NON_NULL);
    ...
    public static ObjectMapper makeBaseXssSerializerObjectMapper() {
        CharacterEscapes characterEscapes = new CharacterEscapes() {
            ...
            {
                // To help protect against XSS attacks, escape characters significant to HTML
